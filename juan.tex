...
\hline
\multicolumn{2}{|c|}{\sc \small Ganancia} & {\sc \small Factor de potencia de la entrop\'ia} & {\sc \small Ganancia de energ\'ia de la entrop\'ia en decibeles} & {\sc \small Respuesta impulso} \\
\hline
& \input{./Imagenes/cuadro5.1/ganancia1.tex} & $\frac{1}{e^2}$ & $-8.69$ & $\frac{\sin^2(t/2)}{t^2 / 2}$ \\
\hline
& \input{./Imagenes/cuadro5.1/ganancia2.tex} & $\left (\frac{2}{e}  \right )^{4}$ & $-5.33$ & $2\left [ \frac{\sin t}{t^3} - \frac{\cos t}{t^2} \right ]$ \\
\hline
& \input{./Imagenes/cuadro5.1/ganancia3.tex} & $0.411$ & $-3.87$ & $6\left [ \frac{\cos t - 1}{t^4} - \frac{\cos t}{2t^2} + \frac{\sin t}{t^3} \right ]$ \\
\hline
& \input{./Imagenes/cuadro5.1/ganancia4.tex} & $\left (\frac{2}{e}  \right )^{2}$ & $-2.67$ & $\frac{\pi }{2} \frac{J_{1}\left ( t \right )}{t}$ \\
\hline
& \input{./Imagenes/cuadro5.1/ganancia5.tex} & $\frac{1}{e^{2\alpha}}$ & $-8.69\alpha$ & $\frac{1}{\alpha t^{2}} \left[ \cos \left( 1 - \alpha \right) t - \cos t \right]$ \\
\hline
\end{tabular}
\end{center}
\end{table}
