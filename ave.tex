...
Para los valores intermedios de la capacidad del canal p estara entre \log{2} y \log{3}.Esta distinci\'on \bigskipen entre el segundo y tercer s\'imbolo transmite alguna informaci\'on, pero no tanto como en el caso sin ruido.
