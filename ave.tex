...
de ser cambiado en el otro elemto par.Nosotros tenemos (dejar =  \alpha = -[plogp + q\log{q}] y p y q son probabilidades de estar usando los simbolos primero y segundo).
...
En tal caso H_x (y) es independiente de la destribuci\'on de probabilidades de los s\'imbolos de entrada, y esta dad por -\sum p_i \log{p_i}. 
...
En un grupo la probabilidad se distribuye tal como seria si estos eran los unicos simbolos que se utilizan. 
