\part{Preliminares matem\'aticos}
\label{part:3}
...
\chapter{Conjuntos y familias de funciones}
\label{sec:18}
...
resultado.\footnote[5]{Para una demostraci\'on de este teorema y
  discusi\'on adicional, v\'ease el art\'iculo del autor
  ``Communication in the Presence of Noise'' publicado en {\em
    Proceedings of the Institute of Radio Engineers}, v. 37, No. 1,
  Enero, 1949, pp. 10-21.}
